...
namespace student_attendance.Controllers
{
    public class UsersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "user_id,user_name,password,type")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "user_id,user_name,password,type")] User user)
        {
            if (ModelState.IsValid)
            {
